                        ...
                        <div class="right-side fw-700 mainNavCol">
                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><a href="/showfood" class="text-light-white fw-500">Show Food</a>
                                                                    </li>
                                                                    <li><a href="/addFood" class="text-light-white fw-500">Add Food</a>
                                                                    </li>
                            ...
                            <div class="user-details p-relative">
                                <a href="#" class="text-light-white fw-500">
                                    <img src="{{ asset('assets/img/user-1.png') }}" class="rounded-circle" alt="userimg"> <span>Hi, Kate</span>
                                </a>
                                <div class="user-dropdown">
                                    ...
                                    <div class="user-footer text-center mt-3">
                                    <span class="text-light-black d-block mb-2">Not John?</span>
                                    <button id="signout" class="btn btn-danger btn-sm">
                                        Sign Out
                                    </button>
                                </div>
                                </div>
